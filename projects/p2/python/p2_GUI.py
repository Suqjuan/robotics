...
class JointControl(QWidget):
    def __init__(self):
        ...
        # Create a Publisher object for the /p2_arm_controller/command topic
        self.pub = rospy.Publisher('/p2_arm_controller/command', Float64MultiArray, queue_size=10)
    ...
    def publish_position(self):
        ...
        # Publish the message to the /p2_arm_controller/command topic
